      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            {/* Header Badge */}
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-600/20 to-cyan-600/20 border border-blue-500/30 backdrop-blur-sm">
              <FaCogs className="w-4 h-4 text-blue-400 mr-3" />
              <span className="text-sm font-medium text-blue-200">DevOps Excellence</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="inline-flex items-center px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-medium hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer">
                <FaRocket className="w-4 h-4 mr-2" />
                Get Started Now
                <FaArrowRight className="w-4 h-4 ml-2" />
              </button>
              
              <button className="inline-flex items-center px-6 py-3 rounded-xl border border-blue-500/30 text-blue-200 font-medium hover:border-blue-500/50 hover:bg-blue-500/5 transition-all duration-300 backdrop-blur-sm cursor-pointer">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              {features.map((feature, index) => (
                <div 
                  key={feature.title}
                  className="p-4 bg-gradient-to-br from-[#1a1f4b]/30 to-[#0d1333]/30 backdrop-blur-sm rounded-xl border border-blue-500/10 hover:border-blue-500/30 transition-all duration-300"
                  style={{ animationDelay: `${index * 150}ms` }}
                >
                  <div className="flex items-start space-x-3">
                    <div className="flex-shrink-0 p-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-lg border border-blue-500/30">
