...
const NewSectionCommon: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'News' | 'news'>('News');

  const filteredItems = News.filter(item =>
    activeTab === 'News' ? item.type === 'blog' : item.type === 'news'
  );
    ...
    <section className="relative py-24  overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* <div className="text-center mt-12   flex items-center justify-center">
          <CTAButton onClick={() => console.log('Clicked!')} variant="primary">Load More </CTAButton>
        </div> */}
      </div>
