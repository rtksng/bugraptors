        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-white/10">
            <div className="grid lg:grid-cols-3 gap-0 items-center min-h-[400px]">
              {/* Left Content */}
              <div className="p-8 lg:p-12 bg-gradient-to-br from-yellow-900/20 to-green-900/20">
                ...
                <button className="inline-flex items-center text-purple-400 font-semibold hover:text-purple-300 transition-colors duration-300 group">
                  More Details
              ...
              {/* Center - Book Image */}
              <div className="flex items-center justify-center p-8 bg-white/5 relative">
              ...
              <div className="p-8 lg:p-12 bg-gradient-to-br from-purple-900/20 to-pink-900/20 relative overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative z-10">
                  ...
                  <div className="absolute -left-8 top-8 hidden lg:block">
                    <svg className="w-16 h-8 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 64 32">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} strokeDasharray="5,5" d="M2 16h40m-10-10l10 10-10 10" />
                    </svg>
                  </div>

                  <h2 className="text-2xl lg:text-3xl font-bold mb-6">
                    <span className="text-purple-400">Never miss an </span>
                    <span className="text-purple-300">update!</span>
                  </h2>
                  ...
                  <form className="space-y-4">
                    <div>
                      <input
                        ...
                        className="w-full px-4 py-3 border border-white/20 bg-white/10 backdrop-blur-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-400"
                      />
                    </div>
                    <div>
                      <input
                    ...
                    <div className="flex items-center space-x-3 p-3 border border-white/20 rounded-lg bg-white/10 backdrop-blur-sm">
                    ...
                    <button className="w-full custom-bg-color hover:opacity-90 text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">
                      Subscribe
                    </button>
                  </form>
                </div>
