  ...
  return (
    <div className="dark bg-[#020317] min-h-screen overflow-x-hidden">
      ...
      <main className="pt-16 sm:pt-20">
        ...
        <HeroesCommon
          align="left"
          title="Transforming Mobile Solutions With Advanced Automation"
          description="Bringing you one of the most advanced mobile test automation frameworks made to accelerate productivity and test effectiveness. From overcoming software challenges to empowering digital businesses, MoboRaptors is our proprietory mobile test automation framework."
          buttonText="Consult Our Mobile Automation Experts"
          tag="MoboRaptors" subtitle={''} />
