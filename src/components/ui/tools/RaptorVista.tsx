    ...
    <div className="max-w-7xl mx-auto space-y-16">
      ...
      <div className="bg-gray-800/50 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl border border-blue-700/50 p-8 relative max-w-full">
        <div className="relative flex justify-between items-start max-w-full px-4 py-12 overflow-x-auto lg:overflow-visible">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500/50 via-indigo-600/50 to-indigo-700/50">
          ...
          },
          {
            ...
            <div
              ...
              className={`relative z-20 flex-shrink-0 w-64 flex flex-col items-center text-center px-4 group ${
                index > 0 ? 'ml-12' : ''
              }`}
            >
              {/* Number Circle */}
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        ...
        <section className="py-10 bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white font-sans">
  <div className="container mx-auto px-4 max-w-5xl">
    {/* Title */}
