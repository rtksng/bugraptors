  ...
  return (
    <div className="dark bg-[#020317] min-h-screen overflow-x-hidden">
      ...
      <main className="pt-16 sm:pt-20">
        {/* Hero Section */}
        <HeroSection
          logoIcon={raptorVistaIcon}
          logoText="RaptorVista"
          mainHeading="Advanced Visual Testing Platform"
          highlightText=""
          description="Detect visual regressions, ensure cross-browser compatibility, and maintain UI consistency"
          ctaText="Start Visual Testing"
