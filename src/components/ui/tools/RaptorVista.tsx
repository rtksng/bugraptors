...
const RaptorVista: React.FC = () => {
  const handleCtaClick = () => {
    console.log('RaptorVista Learn More clicked - redirect to documentation');
  };
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-white">No Boiler Plate Code</h3>
                  </div>
                  <p className="text-gray-400">Streamlined automation framework that eliminates redundant boilerplate code for efficient test development.</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                    <h3 className="text-lg font-semibold text-white">Diverse Environment Support</h3>
                  </div>
                  <p className="text-gray-400">Comprehensive support for multiple testing environments and platform configurations.</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                    <h3 className="text-lg font-semibold text-white">Customized Reports</h3>
                  </div>
                  <p className="text-gray-400">Generate detailed, customizable reports tailored to your specific testing requirements and metrics.</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                    <h3 className="text-lg font-semibold text-white">Load Test & Defect Tracking</h3>
                  </div>
                  <p className="text-gray-400">Integrated load testing capabilities with comprehensive defect identification and tracking features.</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                    <h3 className="text-lg font-semibold text-white">Everything is externalized - Property Driven</h3>
                  </div>
                  <p className="text-gray-400">Externalized configuration system enabling property-driven test automation management.</p>
                </div>

                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="w-3 h-3 bg-purple-500 rounded-full mr-3"></div>
                    <h3 className="text-lg font-semibold text-white">Third-party Integration like Browser Stack, Saucelabs</h3>
                  </div>
                  <p className="text-gray-400">Seamless integration with popular testing platforms like Browser Stack and Sauce Labs for enhanced testing capabilities.</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="relative">
                  <div className="space-y-6">
                    <div className="flex items-center group">
                      <div className="w-16 h-16 custom-bg-color rounded-full flex items-center justify-center text-white font-bold text-xl mr-6 group-hover:scale-110 transition-transform duration-300">
                        01
                      </div>
                      <div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-16 items-start">
                ...
                <div className="text-center">
                  <div className="w-20 h-20 custom-bg-color rounded-full flex items-center justify-center mx-auto mb-8">
              ...
              <div className="text-center mt-16">
                <button className="group relative px-8 py-4 custom-bg-color hover:opacity-90 text-white font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all duration-300">
